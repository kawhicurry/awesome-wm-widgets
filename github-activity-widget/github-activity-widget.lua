...
local DOWNLOAD_AVATAR_CMD = [[sh -c "proxychains -q curl -n --create-dirs -o  %s/avatars/%s %s"]]
local UPDATE_EVENTS_CMD = [[sh -c "proxychains -q curl -s --show-error https://api.github.com/users/%s/received_events ]]
	.. [[> %s/activity.json"]]
